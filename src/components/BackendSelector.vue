...
.flex.flex-column.align-items-center
  Dropdown#backend(optionLabel="label", optionValue="id", optionGroupLabel="label" optionGroupChildren="backends" v-model="backend.backend_id", :options="backend.backend_options" title="Selection of the server backend" v-if="backend.backend_id !== 'forge'")
